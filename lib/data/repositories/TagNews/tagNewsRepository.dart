...
class TagNewsRepository {
  ...
  Future<Map<String, dynamic>> getTagNews({required BuildContext context, required String tagId, required String userId, required String langId, String? latitude, String? longitude}) async {
    final result = await _tagNewsRemoteDataSource.getTagNews(context: context, userId: userId, tagId: tagId, langId: langId, latitude: latitude, longitude: longitude);
