...
class SectionByIdRepository {
  ...
  Future<List<FeatureSectionModel>> getSectionById({required String userId, required String langId, required String sectionId, String? latitude, String? longitude}) async {
    final result = await _sectionByIdRemoteDataSource.getSectionById(langId: langId, userId: userId, sectionId: sectionId, latitude: latitude, longitude: longitude);
