...
class GetUserNewsRepository {
  ...
  Future<Map<String, dynamic>> getGetUserNews({required String offset, required String limit, required String userId, required String langId, String? latitude, String? longitude}) async {
    final result = await _getUserNewsRemoteDataSource.getGetUserNews(limit: limit, offset: offset, langId: langId, userId: userId, latitude: latitude, longitude: longitude);
