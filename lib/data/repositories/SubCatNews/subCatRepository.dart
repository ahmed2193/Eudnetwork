...
class SubCatNewsRepository {
  ...
  Future<Map<String, dynamic>> getSubCatNews(
      ...
      required String langId}) async {
    final result = await _subCatNewsRemoteDataSource.getSubCatNews(
        limit: limit, offset: offset, context: context, langId: langId, userId: userId, subCatId: subCatId, catId: catId, latitude: latitude, longitude: longitude);
