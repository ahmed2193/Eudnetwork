...
class SectionRepository {
  ...
  Future<Map<String, dynamic>> getSection({required BuildContext context, required String langId, required String userId, String? latitude, String? longitude}) async {
    final result = await _sectionRemoteDataSource.getSections(context: context, langId: langId, userId: userId, latitude: latitude, longitude: longitude);
    return {
