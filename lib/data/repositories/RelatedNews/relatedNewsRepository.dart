...
class RelatedNewsRepository {
  ...
  Future<Map<String, dynamic>> getRelatedNews({
    ...
    final result =
        await _relatedNewsRemoteDataSource.getRelatedNews(userId: userId, langId: langId, catId: catId, subCatId: subCatId, latitude: latitude, longitude: longitude, offset: offset, perPage: perPage);
