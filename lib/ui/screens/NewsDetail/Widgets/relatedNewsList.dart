...
class RelatedNewsList extends StatefulWidget {
  ...
  const RelatedNewsList({Key? key, required this.model}) : super(key: key);
  ...
  Widget relatedNewsData(NewsModel model, List<NewsModel> newsList) {
    return Stack(children: [
      ClipRRect(
          ...
          child: ShaderMask(
              shaderCallback: (rect) {
                return const LinearGradient(begin: Alignment.center, end: Alignment.bottomCenter, colors: [Colors.transparent, secondaryColor]).createShader(rect);
              },
