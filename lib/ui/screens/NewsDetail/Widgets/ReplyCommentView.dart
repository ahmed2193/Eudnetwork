...
class ReplyCommentView extends StatefulWidget {
  ...
  const ReplyCommentView({Key? key, required this.replyComIndex, required this.replyComFun, required this.newsId}) : super(key: key);
                                    ...
                                    onTap: () {
                                      if (context.read<AuthCubit>().getUserId() != "0") {
                                        context
                                            ...
                                            .setLikeAndDislikeComm(userId: context.read<AuthCubit>().getUserId(), comment: model, status: (model.like == "1") ? "0" : "1", fromLike: true);
                                      } else {
                                      ...
                                      child: InkWell(
                                        ...
                                        onTap: () {
                                          if (context.read<AuthCubit>().getUserId() != "0") {
                                            context
                                                .read<LikeAndDislikeCommCubit>()
                                                .setLikeAndDislikeComm(userId: context.read<AuthCubit>().getUserId(), comment: model, status: (model.dislike == "1") ? "0" : "2", fromLike: false);
                                          } else {
                                            loginRequired(context);
                                          }
                                        },
