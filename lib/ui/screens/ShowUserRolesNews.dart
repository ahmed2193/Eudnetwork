                ...
                SizedBox(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      categoryName(categoryName: model.categoryName!),
                    ],
                  ),
                ),
                Expanded(
  ...
  Widget categoryName({required String categoryName}) {
    return Padding(
      ...
      child: CustomTextLabel(
          ...
          softWrap: true,
          textStyle:
              Theme.of(context).textTheme.bodyMedium!.copyWith(color: UiUtils.getColorScheme(context).primaryContainer.withOpacity(0.8), fontWeight: FontWeight.w600, fontStyle: FontStyle.normal)),
    );
  }
