              ...
              builder: (context, state) {
                if (state is SectionByIdFetchSuccess) {
                  return Row(
                    ...
                    return SizedBox(width: 180, child: Padding(padding: const EdgeInsets.all(5), child: setImageCard(index: index, model: model, newsModel: data, allNewsList: state.newsModel)));
                  }));
                }
