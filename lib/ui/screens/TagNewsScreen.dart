                                            ...
                                            onTap: () {
                                              if (context.read<AuthCubit>().getUserId() != "0") {
                                                ...
                                                context
                                                    ...
                                                    .setBookmarkNews(context: context, userId: context.read<AuthCubit>().getUserId(), news: model, status: (isBookmark) ? "0" : "1");
                                              } else {
                                              ...
                                              onTap: () {
                                                if (context.read<AuthCubit>().getUserId() != "0") {
                                                  ...
                                                  context
                                                      ...
                                                      .setLikeAndDisLikeNews(context: context, userId: context.read<AuthCubit>().getUserId(), news: model, status: (isLike) ? "0" : "1");
                                                } else {
                                                  loginRequired(context);
                                                }
                                              },
